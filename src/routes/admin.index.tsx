      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <Panel>
          <div className="flex items-center justify-between border-b border-border px-4 py-3">
            ...
            <Link to="/admin/orders" className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground hover:text-foreground">
              View all
            </Link>
          </div>
        ...
        <Panel>
          <div className="flex items-center justify-between border-b border-border px-4 py-3">
            ...
            <Link to="/admin/customers" className="font-mono text-[10px] uppercase tracking-[0.14em] text-muted-foreground hover:text-foreground">
              View all
            </Link>
          </div>
