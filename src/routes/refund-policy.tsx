...
function RefundPolicyPage() {
  return (
    <LegalPage eyebrow="Purchases" title="Refund policy">
      <section><h2>1. How purchases are sold</h2><p>LegitBodyFix is operated by Song J. Digital programs are sold through Paddle, our merchant of record and authorised reseller. Paddle receives the payment and processes eligible refunds to the original payment method.</p></section>
