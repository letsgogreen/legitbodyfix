...
function ProgramLibrary() {
  ...
  const learningContent = useMemo(() => learningContentFor(programSlug, program?.name ?? "", program?.learning_content), [program?.learning_content, program?.name, programSlug]);
