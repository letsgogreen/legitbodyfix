...
function PrivacyPage() {
  return (
    <LegalPage eyebrow="Legal" title="Privacy notice">
      <section><h2>1. Information we process</h2><p>We may process your email address and authentication information, records of programs you can access, support messages you send, and basic technical information needed to operate and secure the site. Payment card details are collected and processed by Paddle rather than stored by LegitBodyFix.</p><p>Our first-party analytics records the page visited, a random per-tab session identifier, general device category, referring website domain, campaign tags included in a link, and coarse country and region codes supplied by our hosting provider. We do not use this analytics system to store your IP address, name, email address, city-level or precise location, or the full referring URL.</p></section>
