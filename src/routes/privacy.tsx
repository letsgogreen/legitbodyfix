...
function PrivacyPage() {
  return (
    <LegalPage eyebrow="Legal" title="Privacy notice">
      <section><h2>1. Information we process</h2><p>We may process your email address and authentication information, records of programs you can access, support messages you send, and basic technical information needed to operate and secure the site. Payment card details are collected and processed by Paddle rather than stored by LegitBodyFix.</p><p>Our first-party analytics records the page visited, random browser and per-tab session identifiers, general device category, referring website domain, campaign tags included in a link, and approximate country, region, and city supplied by our hosting provider. We also store a keyed, non-reversible representation of the public IP address to recognize repeat networks without retaining the raw address. These analytics identifiers are not connected to a customer account. We do not store names, email addresses, precise GPS location, raw IP addresses, or full referring URLs in analytics.</p></section>
      ...
      <section><h2>4. Retention and security</h2><p>We keep information only as long as reasonably needed for the purposes described above, including providing ongoing purchased access, understanding aggregate site use, and meeting legal obligations. Analytics records are separated from customer account information. We use reasonable technical and organisational safeguards, but no online system can be guaranteed completely secure.</p></section>
      ...
      <section><h2>7. Operator and contact</h2><p>LegitBodyFix is operated by Song J. For a privacy question or request, email <a href="mailto:thriveinside@protonmail.com">thriveinside@protonmail.com</a>. For information Paddle processes as merchant of record, see <a href="https://www.paddle.com/legal/privacy" target="_blank" rel="noreferrer">Paddle’s Privacy Notice</a>.</p></section>
    </LegalPage>
  );
}
