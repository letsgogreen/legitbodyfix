...
function TermsPage() {
  return (
    <LegalPage eyebrow="Legal" title="Terms of service">
      <section><h2>1. About these terms</h2><p>LegitBodyFix is operated by Song J. These terms govern your use of LegitBodyFix, including our movement guides, programs, videos, and related digital content. By using the site or purchasing a program, you agree to these terms.</p></section>
