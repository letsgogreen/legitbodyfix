...
function RecipeSourceCollector() {
  ...
  return <div className="mx-auto max-w-6xl px-5 py-6 lg:px-8">
    <PageHead title="Collect external sources" meta="Paste up to 20 public HTTPS pages · review first · drafts only" actions={<Link to="/admin/recipes" className="inline-flex min-h-10 items-center gap-2 rounded-sm border border-border px-3 py-2 text-xs font-bold"><ArrowLeft className="h-3.5 w-3.5" /> Corrective Movement Strategies</Link>} />
