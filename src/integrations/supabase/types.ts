  ...
  public: {
    Tables: {
      ...
      recipes: {
        Row: {
          ...
          notion_url: string | null;
          progression_level: Database["public"]["Enums"]["recipe_progression_level"] | null;
          published: boolean;
          published_at: string | null;
          regions: string[];
          review_status: Database["public"]["Enums"]["content_review_status"];
    ...
    Enums: {
      candidate_match_status:
        "unmatched" | "matched" | "possible_duplicate" | "merged" | "rejected";
      content_review_status:
        ...
        | "published"
        | "archived";
      image_review_status: "pending" | "approved" | "replacement_requested" | "missing";
      import_batch_status: "draft" | "previewed" | "committed" | "rolled_back" | "failed";
      import_row_outcome: "new" | "updated" | "unchanged" | "conflict" | "invalid";
...
export const Constants = {
  public: {
    Enums: {
      candidate_match_status: ["unmatched", "matched", "possible_duplicate", "merged", "rejected"],
      content_review_status: [
        "draft",
        "needs_data_review",
        "needs_image_review",
